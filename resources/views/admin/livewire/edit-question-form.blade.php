    ...
    <div class="my-5 container mx-auto">
        <div class="lg:max-w-2xl mx-auto bg-white rounded-md shadow-md overflow-hidden border-t-4 border-gray-500">
            <div class="px-6 py-4">
                ...
                <form wire:submit.prevent='updateQuestion' class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900">Opsi
                                jawaban</label>
                            <div class="flex">
                                ...
                                @enderror border-gray-300 text-gray-900 text-sm rounded-lg focus:border-gray-800 focus:outline-none focus:ring-0 block w-full p-2.5">
                                        ...
                                        <option value="baik" {{ $answer_option == 'baik' ? 'selected' : '' }}>
                                            Baik
                                        </option>
                                        <option value="efisien" {{ $answer_option == 'efisien' ? 'selected' : '' }}>
                                            Efisien
                                        </option>
                                    </select>
                                </div>
                    ...
                    <div class="flex justify-end mb-2 mt-6">
                        ...
                        <button type="submit"
                            class="bg-gray-800 hover:bg-gray-600 text-white font-bold py-2 px-6 rounded">Simpan</button>
                    </div>
                </form>
            </div>
            <hr>
